...
@Composable
fun RecommendationsSection(recommendations: List<Recommendation>, onClicked:(String)->Unit) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp)
        ...
        LazyRow(
            ...
            items(infiniteItems) { recommendation ->
                RecommendationCard(recommendation = recommendation, onClicked=onClicked)
            }
        }
    }
}
