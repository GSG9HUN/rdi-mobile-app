...
@Singleton
class MangaDomainImpl @Inject constructor(private val mangaRepository: MangaRepository) :
    MangaDomain {
    override fun getTopMangas(type: String, filter: String, page: Int): Flow<Resource<List<Manga>>> {
        return flow {
