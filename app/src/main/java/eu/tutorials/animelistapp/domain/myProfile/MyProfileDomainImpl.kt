...
@Singleton
class MyProfileDomainImpl @Inject constructor(
    private val myProfileRepository: MyProfileRepository,
) : MyProfileDomain {
    override fun getMyProfileData(): Flow<Resource<MyProfileData>> {
        return flow {
    ...
    override fun insertMyProfileData(myProfileData: MyProfileData): Flow<Resource<Int>> {
        return flow {
            emit(Resource.Loading())
            try {
